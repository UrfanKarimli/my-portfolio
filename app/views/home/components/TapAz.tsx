    ...
    return (
        <div className='relative w-full bg-[#f5f5f5] flex flex-col lg:flex-row items-center justify-between p-6  my-10  border border-[#1b1b1b] rounded-2xl'>
            <div className=' basis-[49%] flex flex-col gap-5'>
                <h2 className='text-[#ff4f08] text-[40px]  font-semibold leading-none'>Tap.az <sub>(copy)</sub></h2>
                <p className=' text-[#8d94ad] '>The main objective of this project is to gain practical experience with React.js technologies and become familiar with modern frontend tools.
